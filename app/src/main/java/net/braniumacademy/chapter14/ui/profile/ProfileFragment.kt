package net.braniumacademy.chapter14.ui.profile
...
import net.braniumacademy.chapter14.databinding.FragmentProfileBinding
import net.braniumacademy.chapter14.ui.dateToString
import net.braniumacademy.chapter14.ui.home.HomeFragmentDirections
import net.braniumacademy.chapter14.ui.login.LoginFragment
...
class ProfileFragment : Fragment() {
    ...
    private fun showProfile(user: Profile?) {
        user?.let {
